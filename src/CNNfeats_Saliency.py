...
class VideoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        filterName = 'lanczos'
        out_yuv = '../tmp/temp_saliency/' + self.video_names[idx] + '.yuv'
        tmp_yuv = '../tmp/temp_saliency/' + 'tmp.yuv'
        out_avi = '../tmp/temp_saliency/' + self.video_names[idx] +'.avi'
...
if __name__ == "__main__":
    ...
    if args.database == 'YOUTUBE_UGC_360P':
        ...
        features_dir = '../CNN_features/CNN_features_360P_sample/'
        datainfo = '../mos_file/data_info/YOUTUBE_UGC_360P_info.mat'
    elif args.database == 'YOUTUBE_UGC_480P':
        videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/480P/'
        features_dir = '../CNN_features/CNN_features_480P_sample/'
        datainfo = '../mos_file/data_info/YOUTUBE_UGC_480P_info.mat'
    elif args.database == 'YOUTUBE_UGC_720P':
        videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/720P/'
        features_dir = '../CNN_features/CNN_features_720P_sample/'
        datainfo = '../mos_file/data_info/YOUTUBE_UGC_720P_info.mat'
    elif args.database == 'YOUTUBE_UGC_1080P':
        videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/2160P/'
        features_dir = '../CNN_features/CNN_features_1080P_sample/'
        datainfo = '../mos_file/data_info/YOUTUBE_UGC_1080P_info.mat'
    elif args.database == 'YOUTUBE_UGC_2160P':
        videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/2160P/'
        features_dir = '../CNN_features/CNN_features_2160P_sample/'
        datainfo = '../mos_file/data_info/YOUTUBE_UGC_2160P_info.mat'
        ...
        features_dir = '../CNN_features/CNN_features_1080P_test_sample/'
        datainfo = '../mos_file/data_info/YOUTUBE_UGC_1080P_test_info.mat'
    ...
    df.to_csv(f'../log/{args.database}_VSFACNN_Saliency_runtimes.csv', index=False)