...
%%
% parameters
algo_name = 'NSS_CNN_Saliency'; % algorithm name, eg, 'V-BLIINDS'
...
for i = 1:num_videos
    ...
    out_avi = [resize_path, 'tmp_NCS.avi'];

%     cmd2 = ['ffmpeg -s ' resolution ' '...
%     ' -pix_fmt ' pixfmt ' '...
%     ' -i '  yuv_name ' '...
...
%      out_yuv];
    ...
    feats_frames = calc_RAPIQUE_NSS_CNN_Saliency(yuv_name, width, height, ...
