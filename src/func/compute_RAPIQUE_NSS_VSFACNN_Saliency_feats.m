...
%%
% parameters
algo_name = 'NSS_VSFACNN_Saliency'; % algorithm name, eg, 'V-BLIINDS'
...
for i = 1:num_videos
    ...
    tStart = tic;
    mat_file = ['../../feat_file/', data_name,'_','VSFACNN_Saliency','_feats.mat'];
    cnn_num = i-1;
    ...
    feats_frames = calc_RAPIQUE_NSS_VSFACNN_Saliency(yuv_name, width, height, ...
