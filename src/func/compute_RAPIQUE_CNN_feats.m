...
%ffmpegPath = "C:\Users\um20242\ffmpeg\bin\";
%addpath(ffmpegPath)

%%
% parameters
algo_name = 'CNN'; % algorithm name, eg, 'V-BLIINDS'
...
%    cmd = strcat(cmd, {32}, yuv_name);
    ...
    tStart = tic;
    feats_frames = calc_RAPIQUE_CNN(yuv_name, width, height, ...
