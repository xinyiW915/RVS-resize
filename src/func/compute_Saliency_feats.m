...
%%
% parameters
algo_name = 'Saliency'; % algorithm name, eg, 'V-BLIINDS'
...
%     root_path = '/Users/xxxyy/Library/CloudStorage/OneDrive-UniversityofBristol/Documents/PycharmProjects/UoB/dataset/KoNViD_1k/';
%     data_path = '/Users/xxxyy/Library/CloudStorage/OneDrive-UniversityofBristol/Documents/PycharmProjects/UoB/dataset/KoNViD_1k/KoNViD_1k_videos/';
...
%    cmd1 = strcat(ffmpegPath, 'ffmpeg.exe -loglevel error -y -i ');
%    cmd1 = strcat(cmd1, {32}, video_name, ' -pix_fmt yuv420p -vsync 0 ');
%    cmd1 = strcat(cmd1, {32}, yuv_name); %win
%    system(cmd1);
    ...
    ' -pix_fmt ' pixfmt ' '...
     ...
     system(cmd2);
%win
%    cmd2 = strcat( ffmpegPath, 'ffmpeg.exe -f rawvideo -s', {32}, resolution);
%    cmd2 = strcat(cmd2, {32}, '-pix_fmt', {32}, pixfmt, ' -i ');
%    cmd2 = strcat(cmd2, {32}, yuv_name); %win
%    cmd2 = strcat(cmd2, {32}, '-vf scale=', resolutionNew); %win
%    cmd2 = strcat(cmd2, {32}, '-c:v rawvideo'); %win
%    cmd2 = strcat(cmd2, {32}, '-pix_fmt ', {32}, pixfmt, {32}, out_yuv); %win
%    system(cmd2);
     ...
     system(cmd3)
%win
%    cmd3 = strcat( ffmpegPath, 'ffmpeg.exe -f rawvideo -s', {32}, resolutionNew);
%    cmd3 = strcat(cmd3, {32}, '-pix_fmt yuv420p -i', {32}, out_yuv);
%    cmd3 = strcat(cmd3, {32}, '-c:v rawvideo', {32}, out_avi); %win
%    system(cmd3);
